...
export type About = Node & {
  ...
  /** System stage field */
  stage: Stage;
  telephoneWhatsapp?: Maybe<Scalars['String']>;
...
export type AboutCreateInput = {
  ...
  slug: Scalars['String'];
  telephoneWhatsapp?: InputMaybe<Scalars['String']>;
...
export type AboutManyWhereInput = {
  ...
  telephoneWhatsapp?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  telephoneWhatsapp_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  telephoneWhatsapp_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  telephoneWhatsapp_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  telephoneWhatsapp_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  telephoneWhatsapp_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  telephoneWhatsapp_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  telephoneWhatsapp_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  telephoneWhatsapp_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  telephoneWhatsapp_starts_with?: InputMaybe<Scalars['String']>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
...
export enum AboutOrderByInput {
  ...
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
  TelephoneWhatsappAsc = 'telephoneWhatsapp_ASC',
  TelephoneWhatsappDesc = 'telephoneWhatsapp_DESC',
...
export type GetPagesQuery = { __typename?: 'Query', abouts: Array<{ __typename?: 'About', id: string, heading: string, slug: string, telephoneWhatsapp?: string | null, email?: string | null, linkedin?: string | null, body: { __typename?: 'RichText', html: string } }> };
...
export type GetPageBySlugQuery = { __typename?: 'Query', about?: { __typename?: 'About', id: string, slug: string, heading: string, telephoneWhatsapp?: string | null, email?: string | null, linkedin?: string | null, body: { __typename?: 'RichText', html: string } } | null };
